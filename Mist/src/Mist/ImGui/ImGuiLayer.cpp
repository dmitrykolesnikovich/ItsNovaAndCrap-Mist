...
#include <imgui.h>
#include "Mist\Platform\OpenGL\ImGuiOpenGLRenderer.h"
...
namespace Mist {
	...
	void ImGuiLayer::OnEvent(Event& e)
	{
		...
		dispatcher.Dispatch<WindowResizeEvent>(MST_BIND_EVENT_FN(ImGuiLayer::OnWindowResizeEvent));
		dispatcher.Dispatch<WindowMovedEvent>(MST_BIND_EVENT_FN(ImGuiLayer::OnWindowMovedEvent));
		dispatcher.Dispatch<WindowCloseEvent>(MST_BIND_EVENT_FN(ImGuiLayer::OnWindowCloseEvent));
		dispatcher.Dispatch<WindowFocusEvent>(MST_BIND_EVENT_FN(ImGuiLayer::OnWindowFocusEvent));
		dispatcher.Dispatch<WindowLostFocusEvent>(MST_BIND_EVENT_FN(ImGuiLayer::OnWindowLostFocusEvent));

		dispatcher.Dispatch<KeyPressedEvent>(MST_BIND_EVENT_FN(ImGuiLayer::OnKeyPressedEvent));
		dispatcher.Dispatch<KeyReleasedEvent>(MST_BIND_EVENT_FN(ImGuiLayer::OnKeyReleasedEvent));
		dispatcher.Dispatch<KeyTypedEvent>(MST_BIND_EVENT_FN(ImGuiLayer::OnKeyTypedEvent));

		dispatcher.Dispatch<MouseMovedEvent>(MST_BIND_EVENT_FN(ImGuiLayer::OnMouseMovedEvent));
		dispatcher.Dispatch<MouseScrolledEvent>(MST_BIND_EVENT_FN(ImGuiLayer::OnMouseScrolledEvent));
		dispatcher.Dispatch<MouseButtonPressedEvent>(MST_BIND_EVENT_FN(ImGuiLayer::OnMouseButtonPressedEvent));
		dispatcher.Dispatch<MouseButtonReleasedEvent>(MST_BIND_EVENT_FN(ImGuiLayer::OnMouseButtonReleasedEvent));
	}
